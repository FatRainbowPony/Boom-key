...
{
    public class VectorIconCheckBox : CheckBox
    {
        #region Properties
        ...
        public static readonly DependencyProperty VectorIconProperty =
            DependencyProperty.Register(nameof(VectorIcon), typeof(GeometryGroup), typeof(VectorIconCheckBox), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty VectorIconFillProperty =
            DependencyProperty.Register(nameof(VectorIconFill), typeof(SolidColorBrush), typeof(VectorIconCheckBox), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty VectorIconSizeProperty =
            DependencyProperty.Register(nameof(VectorIconSize), typeof(double), typeof(VectorIconCheckBox), new PropertyMetadata(default(double)));
        ...
        public static readonly DependencyProperty VectorIconStretchProperty =
           DependencyProperty.Register(nameof(VectorIconStretch), typeof(Stretch), typeof(VectorIconCheckBox), new PropertyMetadata(default(Stretch)));
        ...
        public static readonly DependencyProperty VectorIconScaleProperty =
            DependencyProperty.Register(nameof(VectorIconScale), typeof(double), typeof(VectorIconCheckBox), new PropertyMetadata(default(double)));
        ...
        public static readonly DependencyProperty VectorIconMarginProperty =
            DependencyProperty.Register(nameof(VectorIconMargin), typeof(Thickness), typeof(VectorIconCheckBox), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty VectorIconVisibilityProperty =
            DependencyProperty.Register(nameof(VectorIconVisibility), typeof(Visibility), typeof(VectorIconCheckBox), new PropertyMetadata(default(Visibility)));
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register(nameof(Text), typeof(string), typeof(VectorIconCheckBox), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty TextVisibilityProperty =
            DependencyProperty.Register(nameof(TextVisibility), typeof(Visibility), typeof(VectorIconCheckBox), new PropertyMetadata(default(Visibility)));
        ...
        public static readonly DependencyProperty TextMarginProperty =
            DependencyProperty.Register(nameof(TextMargin), typeof(Thickness), typeof(VectorIconCheckBox), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty RoundingCornersProperty =
            DependencyProperty.Register(nameof(RoundingCorners), typeof(CornerRadius), typeof(VectorIconCheckBox), new PropertyMetadata(new CornerRadius(0)));
        ...
        #region Constructors
        static VectorIconCheckBox()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(VectorIconCheckBox), new FrameworkPropertyMetadata(typeof(VectorIconCheckBox)));
        }
