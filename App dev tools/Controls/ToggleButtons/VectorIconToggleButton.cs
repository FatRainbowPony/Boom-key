...
namespace AppDevTools.Controls.ToggleButtons
{
    public class VectorIconToggleButton : ToggleButton
    {
        ...
        public static readonly DependencyProperty VectorIconProperty =
            DependencyProperty.Register(nameof(VectorIcon), typeof(GeometryGroup), typeof(VectorIconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty VectorIconFillProperty =
            DependencyProperty.Register(nameof(VectorIconFill), typeof(SolidColorBrush), typeof(VectorIconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty VectorIconSizeProperty =
            DependencyProperty.Register(nameof(VectorIconSize), typeof(double), typeof(VectorIconToggleButton), new PropertyMetadata(default(double)));
        ...
        public static readonly DependencyProperty VectorIconStretchProperty =
           DependencyProperty.Register(nameof(VectorIconStretch), typeof(Stretch), typeof(VectorIconToggleButton), new PropertyMetadata(default(Stretch)));
        ...
        public static readonly DependencyProperty VectorIconScaleProperty =
            DependencyProperty.Register(nameof(VectorIconScale), typeof(double), typeof(VectorIconToggleButton), new PropertyMetadata(default(double)));
        ...
        public static readonly DependencyProperty VectorIconMarginProperty =
            DependencyProperty.Register(nameof(VectorIconMargin), typeof(Thickness), typeof(VectorIconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty VectorIconVisibilityProperty =
            DependencyProperty.Register(nameof(VectorIconVisibility), typeof(Visibility), typeof(VectorIconToggleButton), new PropertyMetadata(default(Visibility)));
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register(nameof(Text), typeof(string), typeof(VectorIconToggleButton), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty TextVisibilityProperty =
            DependencyProperty.Register(nameof(TextVisibility), typeof(Visibility), typeof(VectorIconToggleButton), new PropertyMetadata(default(Visibility)));
        ...
        public static readonly DependencyProperty TextMarginProperty =
            DependencyProperty.Register(nameof(TextMargin), typeof(Thickness), typeof(VectorIconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty RoundingCornersProperty =
            DependencyProperty.Register(nameof(RoundingCorners), typeof(CornerRadius), typeof(VectorIconToggleButton), new PropertyMetadata(new CornerRadius(0)));
